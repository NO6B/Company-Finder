...
L'application ne stocke aucune donnée sur un serveur et ne nécessite aucun fichier `.env`. Vous devez générer vos propres clés API gratuites et les insérer directement dans l'interface web (via la roue crantée en haut à droite) :
